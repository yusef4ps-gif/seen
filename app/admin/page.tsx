        ...
        <div className="max-w-6xl mx-auto space-y-8 animate-fadeIn">
           ...
           {activeTab === 'owner' && (
             <div className="space-y-6">
                ...
                <div className="p-8 rounded-3xl bg-white dark:bg-slateDark-900 border border-brand-200 dark:border-brand-800 shadow-xl max-w-2xl">
                  <div className="flex flex-col md:flex-row items-center gap-6">
                    <img 
                      src={currentUser.email === 'yusef@seen.store' ? "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80" : "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80"}
                      alt="" 
                    ...
                    <div className="text-center md:text-right space-y-2">
                      ...
                      <div className="text-sm text-brand-600 dark:text-brand-400 font-bold bg-brand-50 dark:bg-brand-950/40 px-3 py-1 rounded-full inline-block">
                        {currentUser.email === 'yusef@seen.store' ? 'المالك والمدير العام (Founder & CEO)' : 'المالك والشريك المؤسس (Co-Founder)'}
                      </div>
                      <div className="text-xs text-slate-500 dark:text-slate-400 font-mono pt-2" dir="ltr">
