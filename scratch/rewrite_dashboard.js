const fs = require('fs');
const path = 'app/merchant/[slug]/page.tsx';
let content = fs.readFileSync(path, 'utf8');

// Add recharts import
const import_recharts = "import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, AreaChart, Area } from 'recharts';\nimport { useMemo } from 'react';";
...
`;
content = content.replace("if (!store) return null;", `if (!store) return null;\n${date_state}`);
